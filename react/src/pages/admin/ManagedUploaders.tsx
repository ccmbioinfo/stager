...
function createFile(name: string, filesUnlinked: number, filesUploaded: number, lastActive: string, secretKey: string, accessKey: string) {
            ...
            <Grid item xs={12}>
                <MaterialTable
                    columns={[
                        ...
                        { title: 'Access Key', field: 'accessKey', type: 'string', render: rowData => <HidableTextButton secretText={rowData.accessKey} /> },
                    ]}
                    data={rows}
                    title="Uploaders"
                    options={{
