...
Revision ID: 2e285dc7b416
Revises: ded8d42ffcb7
Create Date: 2021-03-11 15:37:05.993918
...
def upgrade():
    ...
    sa.Column('variation', sa.Enum('Missense_Variant', 'Splice_Region_Variant', 'Intergenic_Variant', 'Intron_Variant', 'Frameshift_Variant', 'Upstream_Gene_Variant', 'Inframe_Deletion', 'Stop_Gained', 'Inframe_Insertion', 'Downstream_Gene_Variant', 'Synonymous_Variant', 'Non_Coding_Transcript_Exon_Variant', 'Splice_Acceptor_Variant', 'Splice_Donor_Variant', 'Three_prime_UTR_Variant', 'Five_prime_UTR_Variant', 'Regultory_Region_Variant', 'Stop_Lost', 'Start_lost', 'Protein_Altering_Variant', 'Start_Retrained_Variant', 'Mature_miRNA_Variant', 'Stop_Retained_Variant', name='variation'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['gene_id'], ['gene.gene_id'], onupdate='cascade', ondelete='restrict'),
    sa.PrimaryKeyConstraint('variant_id')
    )
    op.create_table('analyzed_variant',
    sa.Column('variant_id', sa.Integer(), nullable=False),
