...
def upgrade():
    ...
    op.add_column("genotype", sa.Column("depth", sa.Integer(), nullable=True))
    op.add_column(
        "genotype", sa.Column("genotype", sa.String(length=50), nullable=True)
    )
    op.add_column(
