...
def create_analysis():
    ...
    email.send_email(from_email='giabaohan.le@sickkids.ca', to_emails='hannah.lgbhan@gmail.com', subject='Test Sendgrid',
                     content=f"Analysis requested by {analysis.requester.username}")
