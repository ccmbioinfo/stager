"""Sprint 1 initial migration

Revision ID: 1391a456d774
Revises: 
Create Date: 2020-09-14 12:45:27.465701
...
def upgrade():
    ...
    sa.Column('pipeline_id', sa.Integer(), nullable=False),
    sa.Column('supported_dataset', sa.Enum('CES', 'CGS', 'CPS', 'RES', 'RGS', 'RLM', 'RMM', 'RRS', 'RTA', 'WES', 'WGS', 'RNASeq', 'RCS', 'RDC', 'RDE', name='datasettype'), nullable=False),
    sa.ForeignKeyConstraint(['pipeline_id'], ['pipeline.pipeline_id'], onupdate='cascade', ondelete='restrict'),
    ...
    sa.Column('participant_type', sa.Enum('Proband', 'Mother', 'Father', 'Sibling', name='participanttype'), nullable=False),
    ...
    sa.Column('dataset_type', sa.Enum('CES', 'CGS', 'CPS', 'RES', 'RGS', 'RLM', 'RMM', 'RRS', 'RTA', 'WES', 'WGS', 'RNASeq', 'RCS', 'RDC', 'RDE', name='datasettype'), nullable=False),
    sa.Column('input_hpf_path', sa.String(length=500), nullable=True),
    sa.Column('notes', sa.Text(), nullable=True),
